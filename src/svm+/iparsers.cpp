...
Instruction parseR3(VMStateP vm, Opcode opcode, Tokens operands, unsigned *maxreg)
{
  (void)vm;
...
Instruction parseR2(VMStateP vm, Opcode opcode, Tokens operands, unsigned *maxreg)
{
  (void)vm;
  uint8_t regX = tokens_get_byte(&operands, NULL);
  uint8_t regY = tokens_get_byte(&operands, NULL);
...
Instruction parseR1(VMStateP vm, Opcode opcode, Tokens operands, unsigned *maxreg)
{
  (void)vm;
  uint8_t regX = tokens_get_byte(&operands, NULL);
  assert(operands == NULL);
...
Instruction parseR0(VMStateP vm, Opcode opcode, Tokens operands, unsigned *maxreg)
{
  (void)vm;
  (void)maxreg;
  assert(operands == NULL);
...
Instruction parseR1U16(VMStateP vm, Opcode opcode, Tokens operands, unsigned *maxreg)
{
  (void)vm;
  (void)maxreg;
  uint8_t regX = tokens_get_byte(&operands, NULL);
...
Instruction parseR2U8(VMStateP vm, Opcode opcode, Tokens operands, unsigned *maxreg)
{
  (void)vm;
  uint8_t regX = tokens_get_byte(&operands, NULL);
  uint8_t regY = tokens_get_byte(&operands, NULL);
...
Instruction parseR0I24(VMStateP vm, Opcode opcode, Tokens operands, unsigned *maxreg)
{
  (void)vm;
  (void)maxreg;
...
Instruction parseR1LIT(VMStateP vm, Opcode opcode, Tokens operands, unsigned *maxreg)
{
...
static Value parsenameliteral(Name parsed_name, Tokens *litp, const char *input)
{
  ...
  else if (parsed_name == stringname)
  {
    ...
    VMStringP str = VMString_new(buff, length);
...
static Value get_literal(Tokens *litp, const char *input)
{
  ...
  case TU32:
  {
    return mkNumberValue(tokens_get_int(litp, input));
  }
  case TDOUBLE:
  {
