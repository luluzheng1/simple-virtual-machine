...
struct
  ...
  fun copyreg dest src = i O.REGS ("mov", dest::src::[])
  ...
  fun mkclosure x y z = i O.REGINT ("mkclosure", x, y, z)
  fun setclslot x z y = i O.REGINT ("setclslot",x, y, z)
  fun getclslot x y z = i O.REGINT ("getclslot",x, y, z)
  fun captured  x slot = getclslot x 0 slot
end
